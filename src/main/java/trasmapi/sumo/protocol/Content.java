...
public class Content {
	...
	public SumoTrafficLightProgram getCompound(){
		/*
		ByteArrayInputStream byteIn;
		DataInputStream dataIn;
		byte content[] = new byte[4];
		...
		*/
		System.out.println("NEW TRAFFIC LIGHT PROGRAM");
		System.out.println("LENGTH : " + varValue.get(0));
		for(int i = 1; i < varValue.size(); i+=2){
			byte type = varValue.get(i);
			byte value = varValue.get(i + 1);
			System.out.println(type + " - " + value);
		}
		
		return new SumoTrafficLightProgram();
	}
