...
public class XMLReader {
	...
	public static void main(String[] args) {
		try {
			File fXmlFile = new File("C:\\Users\\Francisco\\git\\roma\\romaSimulations\\data\\trip5050.xml");
			...
			try{
				fw = new FileWriter(new File("C:\\Users\\Francisco\\git\\roma\\romaSimulations\\data\\trip5050.csv"), true);
